...
package com.rizwan.videocropper.interfaces.interfaces;
/*
Copyright 2020 Rizwan Sayyed (rizwan sayyed)
 */
...
import com.rizwan.videocropper.interfaces.interfaces.utils.TrimVideoUtils;
import com.rizwan.videocropper.interfaces.interfaces.utils.UiThreadExecutor;
import com.rizwan.videocropper.interfaces.interfaces.views.ProgressBarView;
import com.rizwan.videocropper.interfaces.interfaces.views.RangeSeekBarView;
import com.rizwan.videocropper.interfaces.interfaces.views.Thumb;
import com.rizwan.videocropper.interfaces.interfaces.views.TimeLineView;
...
import static com.rizwan.videocropper.interfaces.interfaces.utils.TrimVideoUtils.stringForTime;

public class videoCropper extends FrameLayout {

    private static final String TAG = videoCropper.class.getSimpleName();
    ...
    private OnCropVideoListener mOnCropVideoListener;
    ...
    public videoCropper(@NonNull Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public videoCropper(@NonNull Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context);
    }

    private void init(Context context) {
        LayoutInflater.from(context).inflate(R.layout.cropper_layout, this, true);
    ...
    private void onCancelClicked() {
        Log.d(TAG, "onCancelClicked: started");
        Log.e(TAG, "onCancelClicked: statred");
        Log.i(TAG, "onCancelClicked: started");
     ...
     *
     * @param onCropVideoListener interface for events
     */
    @SuppressWarnings("unused")
    public void setOnK4LVideoListener(OnCropVideoListener onCropVideoListener) {
        mOnCropVideoListener = onCropVideoListener;
    }
    ...
    private static class MessageHandler extends Handler {
        ...
        @NonNull
        private final WeakReference<videoCropper> mView;

        MessageHandler(videoCropper view) {
            mView = new WeakReference<>(view);
        }

        @Override
        public void handleMessage(Message msg) {
            videoCropper view = mView.get();
